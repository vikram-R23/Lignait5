...
const CareerSwitcherWelcomeDashboard = () => {
  const navigate = useNavigate();
  const [progress, setProgress] = useState(0);
  const [statusText, setStatusText] = useState("Initializing AI core...");

  // Status messages specific to Career Switchers
  const statusMessages = [
    { threshold: 15, text: "Analyzing transferable skills..." },
    { threshold: 35, text: "Mapping non-tech experience..." },
    { threshold: 55, text: "Identifying skill gaps..." },
    { threshold: 75, text: "Curating bridge modules..." },
    { threshold: 90, text: "Finalizing transition roadmap..." },
  ...
  return (
    <div className="bg-[#06457F] text-white selection:bg-[#0d93f2]/30 h-screen w-full flex flex-col items-center justify-center overflow-hidden relative font-['Space_Grotesk']">
      ...
      <div className="flex flex-col items-center max-w-[960px] w-full px-4 relative z-10">
        ...
        {/* Orbit Animation Container - Significantly Reduced Scale for Viewport Fit */}
        <div className="relative w-[450px] h-[450px] flex items-center justify-center scale-[0.45] sm:scale-[0.6] md:scale-[0.75] transition-transform duration-500 origin-center">
            ...
            {/* Center Icon - Changed to auto_awesome for switchers */}
            <div className="relative z-10 w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-[0_0_50px_rgba(34,211,238,0.5)]">
                <span className="material-symbols-outlined text-[#06457F] text-4xl font-bold">auto_awesome</span>
            </div>
        ...
        <div className="text-center max-w-2xl -mt-24 sm:-mt-20 md:-mt-10 mb-6">
            <h1 className="text-white tracking-tight text-2xl md:text-4xl font-bold leading-tight mb-2">
                Building your transition-ready <span className="text-[#0d93f2]">roadmap...</span>
            </h1>
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex justify-between items-center mt-1">
                    ...
                    <div className="flex gap-1">
                        <span className="w-1 h-1 bg-[#0d93f2] rounded-full animate-pulse"></span>
                        <span className="w-1 h-1 bg-[#0d93f2] rounded-full animate-pulse [animation-delay:200ms]"></span>
                        <span className="w-1 h-1 bg-[#0d93f2] rounded-full animate-pulse [animation-delay:400ms]"></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="mt-8 flex items-center gap-2 opacity-60">
            <span className="material-symbols-outlined text-[#92b7c9] text-sm">verified_user</span>
            <p className="text-[#92b7c9] text-[10px] font-normal leading-normal">Career Orbit AI Engine • Secure Analysis</p>
        </div>
...
export default CareerSwitcherWelcomeDashboard;