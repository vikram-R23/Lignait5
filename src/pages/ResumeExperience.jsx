...
const ResumeExperience = () => {
  ...
  const [chatMessages, setChatMessages] = useState([
    { id: 1, sender: 'ai', text: 'Hi Baskar! I can help you rewrite your experience bullets to be more impactful. Just ask!' }
  ]);
  ...
  useEffect(() => {
    const fetchExperienceData = async () => {
      try {
        console.log("System Ready: Resume Experience module initialized.");
      } catch (err) {
  ...
  const handleChatSubmit = (e) => {
    ...
    setChatInput("");
    setTimeout(() => {
        const newAiMsg = { id: Date.now() + 1, sender: 'ai', text: "Here is a stronger way to phrase that achievement..." };
  ...
  return (
    <div className="bg-[#06457F] text-white font-['Inter'] h-screen w-full flex overflow-hidden antialiased relative">
      ...
      {/* --- MAIN SIDEBAR (Consistent with Project) --- */}
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="w-64 flex-shrink-0 bg-[#06457F] border-r border-white/10 flex flex-col">
            <div className="p-4">
              ...
              <ul className="space-y-1">
                <li>
                  <button onClick={() => navigate('/resume-editor')} className="w-full flex items-center justify-between p-2.5 rounded-lg text-sm font-medium text-[#D1D5DB] hover:bg-white/5 hover:text-white group text-left transition-all">
                    <div className="flex items-center gap-3">
                      <span className="material-symbols-outlined text-[#D1D5DB] group-hover:text-white text-[20px]">person</span>
                      Personal Info
                    </div>
                  </button>
                </li>
                <li>
                  ...
                  <button className="w-full flex items-center justify-between p-2.5 rounded-lg text-sm font-medium text-white bg-[#0474C4] shadow-md text-left transition-all">
                    <div className="flex items-center gap-3">
                ...
                <li>
                  <button onClick={() => navigate('/resume-education')} className="w-full flex items-center justify-between p-2.5 rounded-lg text-sm font-medium text-[#D1D5DB] hover:bg-white/5 hover:text-white group text-left transition-all">
                    <div className="flex items-center gap-3">
                      <span className="material-symbols-outlined text-[#D1D5DB] group-hover:text-white text-[20px]">school</span>
                      Education
                    </div>
                  </button>
                </li>
                <li>
                  <button onClick={() => navigate('/resume-skills')} className="w-full flex items-center justify-between p-2.5 rounded-lg text-sm font-medium text-[#D1D5DB] hover:bg-white/5 hover:text-white group text-left transition-all">
                    <div className="flex items-center gap-3">
                      <span className="material-symbols-outlined text-[#D1D5DB] group-hover:text-white text-[20px]">build</span>
                      Skills
                    </div>
                  </button>
                </li>
                <li>
                  <button onClick={() => navigate('/resume-projects')} className="w-full flex items-center justify-between p-2.5 rounded-lg text-sm font-medium text-[#D1D5DB] hover:bg-white/5 hover:text-white group text-left transition-all">
                    <div className="flex items-center gap-3">
                      <span className="material-symbols-outlined text-[#D1D5DB] group-hover:text-white text-[20px]">folder</span>
                      Projects
                    </div>
                  </button>
                </li>
                <li>
                  <button onClick={() => navigate('/resume-certifications')} className="w-full flex items-center justify-between p-2.5 rounded-lg text-sm font-medium text-[#D1D5DB] hover:bg-white/5 hover:text-white group text-left transition-all">
                    <div className="flex items-center gap-3">
                      <span className="material-symbols-outlined text-[#D1D5DB] group-hover:text-white text-[20px]">verified</span>
                      Certifications
                    </div>
                  </button>
                </li>
          ...
          <div className="flex-1 bg-[#06457F] overflow-y-auto relative scroll-smooth">
            <div className="max-w-2xl mx-auto p-6 pb-24">
              <div className="mb-8 p-4 bg-[#053b6e]/50 border border-[#0474C4]/30 rounded-xl flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#D1D5DB] mt-1 leading-relaxed">
                    Your resume has been auto-generated using your profile details. You can edit everything below before downloading.
                  </p>
                </div>
              </div>

              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-white" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Work Experience</h2>
              ...
              {/* Position 1 */}
              <div className="bg-[#0f2e46] rounded-xl border border-white/10 p-5 mb-6 group hover:border-[#0474C4]/50 transition-colors">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex gap-2">
                    <button className="text-[#D1D5DB] hover:text-white"><span className="material-symbols-outlined text-[18px]">keyboard_arrow_up</span></button>
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div className="col-span-2 sm:col-span-1">
                    <label className="block text-xs font-medium text-[#D1D5DB] mb-1.5">Job Title</label>
                    <input className="w-full bg-[#1E1E1E] border border-[#3A3A3A] rounded-lg px-3 py-2.5 text-sm text-white placeholder-[#9CA3AF] focus:border-[#0474C4] focus:ring-1 focus:ring-[#0474C4] outline-none transition-all" type="text" defaultValue="Senior Product Designer"/>
                  </div>
                  <div className="col-span-2 sm:col-span-1">
                    <label className="block text-xs font-medium text-[#D1D5DB] mb-1.5">Company</label>
                    <input className="w-full bg-[#1E1E1E] border border-[#3A3A3A] rounded-lg px-3 py-2.5 text-sm text-white placeholder-[#9CA3AF] focus:border-[#0474C4] focus:ring-1 focus:ring-[#0474C4] outline-none transition-all" type="text" defaultValue="TechFlow Inc."/>
                  </div>
                  <div className="col-span-2 sm:col-span-1">
                    <label className="block text-xs font-medium text-[#D1D5DB] mb-1.5">Start Date</label>
                    <input className="w-full bg-[#1E1E1E] border border-[#3A3A3A] rounded-lg px-3 py-2.5 text-sm text-white placeholder-[#9CA3AF] focus:border-[#0474C4] focus:ring-1 focus:ring-[#0474C4] outline-none transition-all" type="text" defaultValue="Jan 2021"/>
                  </div>
                  <div className="col-span-2 sm:col-span-1">
                    <label className="block text-xs font-medium text-[#D1D5DB] mb-1.5">End Date</label>
                    <input className="w-full bg-[#1E1E1E] border border-[#3A3A3A] rounded-lg px-3 py-2.5 text-sm text-white placeholder-[#9CA3AF] focus:border-[#0474C4] focus:ring-1 focus:ring-[#0474C4] outline-none transition-all" type="text" defaultValue="Present"/>
                  </div>
                </div>
                
                <div className="mb-4">
                  <label className="block text-xs font-medium text-[#D1D5DB] mb-1.5">Description</label>
                  <textarea className="w-full bg-[#1E1E1E] border border-[#3A3A3A] rounded-lg px-3 py-2.5 text-sm text-white placeholder-[#9CA3AF] focus:border-[#0474C4] focus:ring-1 focus:ring-[#0474C4] outline-none transition-all leading-relaxed" rows="4" defaultValue="Led the design system overhaul, reducing development time by 30%. Mentored junior designers and established weekly design critiques."></textarea>
                  <div className="flex gap-2 mt-2">
                    <button className="text-[10px] bg-white/5 hover:bg-white/10 text-[#D1D5DB] hover:text-white px-2 py-1 rounded border border-white/5 transition-colors">+ Add Bullet Point</button>
                    <button className="text-[10px] bg-white/5 hover:bg-white/10 text-[#D1D5DB] hover:text-white px-2 py-1 rounded border border-white/5 transition-colors">Rephrase (Manual)</button>
                  </div>
                </div>
              </div>

              {/* Position 2 (Collapsed) */}
              <div className="bg-[#0f2e46]/60 rounded-xl border border-white/5 p-5 hover:border-white/20 transition-colors">
                <div className="flex justify-between items-start mb-4">
                  <h3 className="text-white font-medium flex items-center gap-2">
                    <span className="bg-white/10 text-white/70 size-6 rounded flex items-center justify-center text-xs font-bold">2</span>
                    UX Designer
                  </h3>
                  <div className="flex gap-2">
                    <button className="text-[#D1D5DB] hover:text-white"><span className="material-symbols-outlined text-[18px]">keyboard_arrow_down</span></button>
                    <button className="text-[#D1D5DB] hover:text-white"><span className="material-symbols-outlined text-[18px]">expand_more</span></button>
                  </div>
                </div>
                <div className="flex items-center gap-4 text-sm text-[#D1D5DB]">
                  <span>Creative Pulse Agency</span>
