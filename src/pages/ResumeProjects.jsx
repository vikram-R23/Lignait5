...
const ResumeProjects = () => {
  ...
  const [chatMessages, setChatMessages] = useState([
    { id: 1, sender: 'ai', text: 'Hi Baskar! I can help you describe your projects effectively. What technologies did you use?' }
  ]);
  ...
  useEffect(() => {
    const fetchProjectsData = async () => {
      try {
        console.log("System Ready: Resume Projects module initialized.");
      } catch (err) {
  ...
  const handleChatSubmit = (e) => {
    ...
    setChatInput("");
    setTimeout(() => {
        const newAiMsg = { id: Date.now() + 1, sender: 'ai', text: "That sounds impressive! Here's a way to phrase it for maximum impact..." };
          ...
          <div className="flex-1 bg-[#06457F] overflow-y-auto relative scroll-smooth">
            <div className="max-w-2xl mx-auto p-6 pb-24">
              <div className="mb-8 p-4 bg-[#053b6e]/50 border border-[#0474C4]/30 rounded-xl flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm text-white font-medium">Smart Project Suggestions</p>
                  <p className="text-xs text-[#D1D5DB] mt-1 leading-relaxed">
                    Highlighting your work with 'Fintech Dashboard' shows strong technical proficiency in modern frameworks.
                  </p>
                </div>
              </div>

              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-white" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Projects</h2>
              </div>

              <div className="space-y-6">
                <div className="bg-[#1E1E1E] rounded-xl border border-white/10 p-6 relative">
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        <div>
                            <label className="block text-xs font-medium text-[#D1D5DB] mb-2 uppercase tracking-wider">Project Title</label>
                            <input className="w-full bg-[#121212] border border-[#3A3A3A] rounded-lg px-4 py-2.5 text-sm text-white placeholder-[#9CA3AF] focus:border-[#0474C4] focus:ring-1 focus:ring-[#0474C4] outline-none transition-all" type="text" defaultValue="Fintech Dashboard"/>
                        </div>
                        <div>
                            <label className="block text-xs font-medium text-[#D1D5DB] mb-2 uppercase tracking-wider">Technologies Used</label>
                            <input className="w-full bg-[#121212] border border-[#3A3A3A] rounded-lg px-4 py-2.5 text-sm text-white placeholder-[#9CA3AF] focus:border-[#0474C4] focus:ring-1 focus:ring-[#0474C4] outline-none transition-all" type="text" defaultValue="React, Node.js, AWS"/>
                        </div>
                        <div>
                            <label className="block text-xs font-medium text-[#D1D5DB] mb-2 uppercase tracking-wider">Project Description</label>
                            <textarea className="w-full bg-[#121212] border border-[#3A3A3A] rounded-lg px-4 py-2.5 text-sm text-white placeholder-[#9CA3AF] focus:border-[#0474C4] focus:ring-1 focus:ring-[#0474C4] outline-none transition-all min-h-[120px] resize-none" placeholder="Describe your project's impact and features..." defaultValue="Developed an end-to-end investment portal used by 50k users. Integrated real-time data visualization and secure OAuth2 authentication flow."></textarea>
                        </div>
                    </div>
                </div>
              ...
              <div className="pt-8 flex justify-end pb-12">
                <button 
                  onClick={() => navigate('/resume-certifications')}
